import { IEmbeddingUtil } from "../interfaces/embeddingUtil";
import { Workout, WorkoutMetadata } from "../interfaces/workout";
import { prisma } from "../lib/prisma";
import { embedder, vectorSearch } from "./llm";

 abstract class IWorkoutEmbeddingUtil implements IEmbeddingUtil {
    //custom methods come here
  }

export class WorkoutEmbeddingUtils implements IWorkoutEmbeddingUtil{
    ...
    static async generateEmbeddingText(workout: {
      type: string;
      ...
      if (typeof workout.distance === 'number') {
        parts.push(`Distance: ${workout.distance} km`);
      }
